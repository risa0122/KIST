...
# %%  download and list all files to be processed
    ...
    folder_name= os.path.join(caiman_datadir(),'')
    ...
    fld_name = 'mesoscope'
    np.load('training_dataset/neurofinder.00.00/images', fld_name)
    folder_name = os.path.join(caiman_datadir(),'',)


    fnames = sorted(glob('training_dataset/neurofinder.00.00/images/*.tiff'))
